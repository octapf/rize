...
export default function MacroCalculator() {
  ...
  const activityMultipliers = {
    sedentary: { value: 1.2, label: 'Sedentario', description: 'Poco o ning�n ejercicio' },
    light: { value: 1.375, label: 'Ligero', description: '1-3 d�as/semana' },
    moderate: { value: 1.55, label: 'Moderado', description: '3-5 d�as/semana' },
    active: { value: 1.725, label: 'Activo', description: '6-7 d�as/semana' },
    veryActive: { value: 1.9, label: 'Muy Activo', description: 'Entrenamiento 2x/d�a' },
  };

  const goalAdjustments = {
    cutting: { label: 'Definici�n', cals: -500, protein: 2.2, desc: 'Perder grasa' },
    maintenance: { label: 'Mantenimiento', cals: 0, protein: 1.8, desc: 'Mantener peso' },
    bulking: { label: 'Volumen', cals: 300, protein: 2.0, desc: 'Ganar m�sculo' },
  };
  ...
  const calculateMacros = () => {
    ...
    if (!h || h <= 0) {
      Alert.alert('Error', 'Ingresa una altura v�lida');
      return;
    }
    if (!a || a <= 0 || a > 120) {
      ...
      <ScrollView className="flex-1" showsVerticalScrollIndicator={false}>
        <View className="px-6 pt-6">
          ...
          <View className="bg-zinc-900 rounded-xl p-6 mb-6 border border-zinc-800">
            <Text className="text-white text-lg font-bold mb-4">Informaci�n Personal</Text>
          ...
          {result && (
            <>
              ...
              <View className="bg-gradient-to-r from-primary to-primary rounded-xl p-6 mb-6">
                <Text className="text-white/70 text-sm mb-2">CALORÍAS DIARIAS</Text>
              ...
              {/* Macros Breakdown */}
              <View className="bg-zinc-900 rounded-xl p-6 mb-6 border border-zinc-800">
                <Text className="text-white text-lg font-bold mb-4">Distribuci�n de Macros</Text>
                ...
                <View className="mb-4">
                  <View className="flex-row items-center justify-between mb-2">
                    <View className="flex-row items-center">
                      ...
                      <Text className="text-white font-bold">Prote�na</Text>
                    </View>
              ...
              <View className="bg-zinc-900 rounded-xl p-6 mb-6 border border-zinc-800">
                ...
                <View className="flex-row justify-between">
                  <View className="flex-1 items-center">
                    <Text className="text-zinc-400 text-xs mb-1">Calor�as</Text>
            ...
            <View className="flex-row items-start">
              ...
              <View className="flex-1 ml-3">
                ...
                <Text className="text-primary/60 text-sm">
                  � Prote�na: 4 kcal/g - Construcci�n muscular{'\n'}
                  � Carbohidratos: 4 kcal/g - Energ�a{'\n'}
            ...
            <View className="flex-row items-start">
              ...
              <View className="flex-1 ml-3">
                ...
                <Text className="text-primary/80 text-sm">
                  Ajusta seg�n resultados despu�s de 2-4 semanas. P�sate en las mismas condiciones diariamente.
                </Text>
              </View>
            </View>
          </View>
