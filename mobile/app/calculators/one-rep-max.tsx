              ...
              {COMMON_EXERCISES.map((ex) => (
                <TouchableOpacity
                  ...
                  className={`px-4 py-3 rounded-lg flex-row items-center ${
                    exercise === ex.name ? 'bg-blue-500' : 'bg-zinc-900 border border-zinc-800'
                  }`}
                >
                  <Ionicons
                    name={ex.icon as any}
          ...
          {result && (
            <View className="mb-6">
              ...
              <TouchableOpacity
                ...
                className="bg-blue-500 rounded-xl p-4 flex-row items-center justify-center mt-4"
              >
          ...
          <View className="bg-zinc-900 rounded-xl p-4 border border-zinc-800 mb-6">
            ...
            <View className="space-y-2">
              <View className="bg-zinc-800 rounded-lg p-3">
                <Text className="text-emerald-400 font-bold mb-1">Epley (Usada Aquí)</Text>
                <Text className="text-zinc-300 text-sm">
                  1RM = Peso × (1 + Reps/30)
                </Text>
              </View>
              <View className="bg-zinc-800 rounded-lg p-3">
                <Text className="text-blue-400 font-bold mb-1">Brzycki</Text>
                <Text className="text-zinc-300 text-sm">
                  1RM = Peso × (36 / (37 - Reps))
                </Text>
              </View>
