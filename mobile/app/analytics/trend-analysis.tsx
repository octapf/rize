...
export default function TrendAnalysis() {
  ...
  const metrics = [
    ...
    { key: 'bodyweight', label: 'Weight', icon: 'scale', color: 'primary', unit: 'kg' },
    ...
    <View className="flex-1 bg-zinc-950">
      ...
      <ScrollView className="flex-1" showsVerticalScrollIndicator={false}>
        <View className="px-6 pt-6">
          ...
          {/* Metric Selection */}
          <Text className="text-white font-bold text-lg mb-3">M�trica</Text>
          ...
          <View className="bg-zinc-900 rounded-xl p-4 mb-6 border border-zinc-800">
            <Text className="text-white font-bold mb-4">Tendencia Hist�rica</Text>
                ...
                datasets: [
                  {
                    ...
                    color: (opacity = 1) => {
                      const colors = {
                        ...
                        primary: `rgba(157, 18, 222, ${opacity})`,
            ...
            <View className="flex-row items-center justify-between mt-3">
              <View className="flex-row items-center">
                ...
                <Text className="text-zinc-400 text-sm">Hist�rico</Text>
              </View>
              <View className="flex-row items-center">
                <View className={`w-3 h-3 bg-${currentMetric.color}-500 rounded-full mr-2 opacity-50`} />
                <Text className="text-zinc-400 text-sm">Predicci�n</Text>
              </View>
            </View>
          </View>
                ...
                <View className="bg-primary/10 rounded-lg p-3 mb-3">
                  <View className="flex-row items-start">
                    ...
                    <Text className="text-primary/80 ml-2 flex-1">
                      Ritmo ideal para hypertrophy. Mant�n este progreso.
                    </Text>
                  </View>
                </View>
              ...
              <>
                <View className="bg-primary/10 rounded-lg p-3 mb-3">
                  <View className="flex-row items-start">
                    <Ionicons name="checkmark-circle" size={20} color="#9D12DE" />
                    <Text className="text-primary ml-2 flex-1">
                      Fuerza aumentando +6.3%. Excelente progresi�n lineal.
                    </Text>
                  </View>
                </View>
                ...
                <View className="bg-primary/10 rounded-lg p-3">
                  <View className="flex-row items-start">
                    ...
                    <Text className="text-primary/80 ml-2 flex-1">
                      Pr�ximo objetivo: 95kg promedio. Alcanzable en 6-8 semanas.
                    </Text>
                  </View>
                </View>
              </>
              ...
              <>
                <View className="bg-primary/10 rounded-lg p-3 mb-3">
                  <View className="flex-row items-start">
                    <Ionicons name="checkmark-circle" size={20} color="#9D12DE" />
                    <Text className="text-primary ml-2 flex-1">
                      Grasa corporal bajando -10.1%. Excelente composici�n.
                    </Text>
                  </View>
                </View>
                ...
                <View className="bg-primary/10 rounded-lg p-3 mb-3">
                  <View className="flex-row items-start">
                    <Ionicons name="bulb" size={20} color="#9D12DE" />
                    <Text className="text-primary/80 ml-2 flex-1">
                      14.2% est� en rango fitness. Meta 12-13% para definici�n.
                    </Text>
                  </View>
                </View>
                ...
                <View className="bg-amber-500/10 rounded-lg p-3">
                  <View className="flex-row items-start">
                    <Ionicons name="warning" size={20} color="#FFEA00" />
                    <Text className="text-amber-400 ml-2 flex-1">
                      No bajes m�s de 1% por mes para preservar m�sculo.
                    </Text>
                  </View>
                </View>
              </>
