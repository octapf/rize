  ...
  const insights: PerformanceInsight[] = [
    {
      ...
      description: 'Basado en tu progresión lineal de las Últimas 6 semanas (+2.5kg/semana), estés cerca de un PR.',
      severity: 'positive',
    ...
    },
    {
      ...
      description: 'Tus métricas de recovery (sueño 8h, frecuencia cardíaca 58 bpm) estén óptimas.',
      severity: 'positive',
    ...
    },
    {
      ...
      description: 'Consumes solo 15g de proteína post-entrenamiento. Óptimo es 25-40g.',
      severity: 'warning',
