...
const WARMUP_ROUTINES: WarmupRoutine[] = [
  {
    ...
    duration: 10,
    focus: 'PreparaciÛn cardiovascular y articular',
    level: 'general',
    exercises: [
      { name: 'Jumping Jacks', duration: '2 min', notes: 'Ritmo moderado, subir temperatura corporal' },
      { name: 'Arm Circles', duration: '1 min', reps: '20 adelante + 20 atr·s', notes: 'CÌrculos amplios, hombros relajados' },
      { name: 'Hip Circles', duration: '1 min', reps: '10 cada direcciÛn', notes: 'Manos en cadera, cÌrculos grandes' },
      { name: 'Leg Swings', duration: '2 min', reps: '15 cada lado', notes: 'Adelante-atr·s y lateral' },
      { name: 'Torso Twists', duration: '1 min', reps: '20 total', notes: 'RotaciÛn suave de tronco' },
  ...
  },
  {
    ...
    level: 'upper',
    exercises: [
      { name: 'Band Pull-Aparts', duration: '2 min', reps: '3x15', notes: 'Con banda el·stica, retracciÛn escapular' },
      ...
      { name: 'Light DB Press', duration: '2 min', reps: '2x12', notes: 'Peso muy ligero, activaciÛn' },
    ],
  ...
  },
  {
    ...
    level: 'lower',
    exercises: [
      { name: 'Glute Bridges', duration: '2 min', reps: '2x15', notes: 'ContracciÛn gl˙teos, hold 1 seg arriba' },
      { name: 'Bodyweight Squats', duration: '2 min', reps: '20 reps', notes: 'Profundidad completa, tempo lento' },
      { name: 'Walking Lunges', duration: '2 min', reps: '10 cada pierna', notes: 'ActivaciÛn gl˙teos y cu·driceps' },
      ...
      { name: 'Leg Swings', duration: '2 min', reps: '15 cada direcciÛn', notes: 'PreparaciÛn din·mica' },
    ],
  ...
  },
  {
    ...
    duration: 15,
    focus: 'PreparaciÛn especÌfica para squat heavy',
    level: 'specific',
    exercises: [
      { name: 'Foam Roll IT Band + Quads', duration: '3 min', notes: 'LiberaciÛn miofascial' },
      ...
      { name: 'Empty Bar Squats', duration: '2 min', reps: '2x8', notes: 'TÈcnica perfecta' },
      { name: 'Ramp-up Sets', duration: '3 min', reps: '50%, 70%, 85% x3', notes: 'Acercarse al peso de trabajo' },
    ],
    benefits: ['Grooving tÈcnica', 'PreparaciÛn neuromuscular', 'Gradiente de carga', 'Confianza mental'],
    icon: 'üèãÔ∏è',
  },
  {
    id: '5',
    ...
    duration: 15,
    focus: 'PreparaciÛn especÌfica para bench press',
    level: 'specific',
    exercises: [
      { name: 'Band Pull-Aparts', duration: '2 min', reps: '3x20', notes: 'ActivaciÛn escapular' },
      { name: 'Push-ups', duration: '2 min', reps: '2x12', notes: 'ActivaciÛn pectorales' },
      { name: 'Empty Bar Bench', duration: '2 min', reps: '2x10', notes: 'Groove patrÛn de movimiento' },
      ...
      { name: 'Ramp-up Sets', duration: '5 min', reps: '50%, 60%, 70%, 80% x5-3', notes: 'AproximaciÛn al peso de trabajo' },
    ],
    benefits: ['Estabilidad escapular', 'ActivaciÛn arco tor·cico', 'PreparaciÛn neurolÛgica', 'PrevenciÛn lesiones hombro'],
    icon: 'üí™',
  },
  {
    id: '6',
    ...
    duration: 15,
    focus: 'PreparaciÛn especÌfica para deadlift',
    level: 'specific',
    exercises: [
      ...
      { name: 'Glute Bridges', duration: '2 min', reps: '2x15', notes: 'ActivaciÛn gl˙teos y core' },
      { name: 'Dead Bugs', duration: '2 min', reps: '10 cada lado', notes: 'Estabilidad core' },
      { name: 'Light Deadlifts', duration: '2 min', reps: '2x5', notes: 'TÈcnica con peso ligero' },
      { name: 'Ramp-up Sets', duration: '5 min', reps: '40%, 60%, 75%, 85% x5-3', notes: 'Build up al peso de trabajo' },
    ],
    benefits: ['PatrÛn bisagra cadera', 'ActivaciÛn posterior chain', 'Setup mental', 'Agarre preparado'],
    icon: 'üèãÔ∏è',
  },
];
...
export default function WarmupRoutines() {
  ...
  const filters = [
    ...
    { id: 'specific', label: 'EspecÌfico', icon: 'fitness' },
  ];
                ...
                <View className="flex-row items-start">
                  ...
                  <View className="flex-1 ml-3">
                    ...
                    <Text className="text-primary/60 text-sm">
                      ï ProgresiÛn: general ‚Üí especÌfico{'\n'}
                      ï Mayor intensidad = m·s warm-up{'\n'}
                      ï En frÌo: +5 min extra{'\n'}
                      ï No fatigues antes de entrenar
                    </Text>
                  </View>
                </View>
              </View>
