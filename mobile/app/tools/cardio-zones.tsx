        ...
        <View className="px-6 pt-6">
          ...
          >
            <View className="flex-row items-center justify-between">
              ...
              {method === 'simple' && <Ionicons name="checkmark-circle" size={24} color="#3B82F6" />}
            </View>
          </TouchableOpacity>
          ...
          {zones.length > 0 && (
            <>
              ...
              <View className="bg-zinc-900 rounded-xl p-5 mb-6 border border-zinc-800">
                ...
                <View className="mb-3">
                  <Text className="text-emerald-400 font-bold mb-1">Pérdida de Grasa:</Text>
                  <Text className="text-zinc-400 text-sm">Zona 2 (60-70%) • 45-60 min • 3-4x/semana</Text>
                </View>

                <View className="mb-3">
                  <Text className="text-blue-400 font-bold mb-1">Resistencia Cardiovascular:</Text>
