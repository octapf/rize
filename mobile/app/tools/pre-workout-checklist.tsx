...
const CHECKLIST_ITEMS: ChecklistItem[] = [
  // Warmup
  {
    ...
    description: 'Elevar temperatura corporal y frecuencia cardÌaca',
    isCompleted: false,
    isRequired: true,
  },
  {
  ...
  // Mobility
  {
    ...
    description: 'CÌrculos de hombros, caderas, tobillos',
    isCompleted: false,
    isRequired: true,
  },
  {
  ...
  },
  {
    ...
    description: 'CinturÛn, muÒequeras, bandas si necesitas',
    isCompleted: false,
    isRequired: false,
  },
  // Nutrition
  ...
  },
  {
    ...
    description: '1-2h antes: carbos + proteÌna moderada',
    isCompleted: false,
    isRequired: true,
  },
  {
  ...
  // Mindset
  {
    ...
    description: 'Sabes quÈ vas a entrenar y tus metas',
    isCompleted: false,
    isRequired: true,
  },
  {
...
export default function PreWorkoutChecklist() {
  ...
  const categories = [
    ...
    { key: 'nutrition', label: 'NutriciÛn', icon: 'restaurant', color: 'amber' },
          ...
          <View className="gap-3 mb-6">
            ...
            >
              ...
              <Text className="text-white font-bold text-lg ml-2">
                {completedRequired === requiredCount ? 'Empezar Workout' : 'Continuar con PrecauciÛn'}
              </Text>
            </TouchableOpacity>
            ...
            <View className="flex-row items-start">
              ...
              <View className="flex-1 ml-3">
                <Text className="text-primary/80 font-bold mb-2">
                  Por QuÈ Usar el Checklist
                </Text>
                <Text className="text-primary/60 text-sm">
                  ï Reduce riesgo de lesiÛn hasta 60%{'\n'}
                  ï Mejora rendimiento 15-20%{'\n'}
                  ï Crea rutina y consistencia{'\n'}
                  ï Identifica gaps en preparaciÛn{'\n'}
                  ï 90%+ readiness = workout Ûptimo
                </Text>
              </View>
            </View>
          </View>
