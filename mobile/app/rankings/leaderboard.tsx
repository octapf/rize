...
const mockLeaderboard: LeaderboardUser[] = [
  { rank: 1, userId: '1', name: 'Carlos GarcÌa', username: 'carlosg', score: 12540, change: 2 },
  { rank: 2, userId: '2', name: 'Ana LÛpez', username: 'ana', score: 11230, change: -1 },
  { rank: 3, userId: '3', name: 'Pedro MartÌnez', username: 'pedro', score: 10890, change: 1 },
  { rank: 4, userId: '4', name: 'MarÌa S·nchez', username: 'maria', score: 9750, change: 0 },
  { rank: 5, userId: 'me', name: 'T˙', username: 'tuuser', score: 8920, change: 3 },
  { rank: 6, userId: '6', name: 'Luis RodrÌguez', username: 'luis', score: 8450, change: -2 },
        ...
        <View className="flex-row gap-2 mb-3">
          {(['week', 'month', 'allTime'] as const).map((range) => (
            ...
            >
              ...
              >
                {range === 'week' ? 'Semana' : range === 'month' ? 'Mes' : 'HistÛrico'}
              </Text>
            </TouchableOpacity>
          ))}
        </View>
