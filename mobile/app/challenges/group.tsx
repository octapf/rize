...
const CHALLENGES: Challenge[] = [
  ...
  },
  {
    ...
    myRank: 12,
    leaderboard: [
      { rank: 1, name: 'Consistent Joe', avatar: 'ðŸ’Ž', value: 21, unit: 'días' },
      { rank: 2, name: 'Daily Grind', avatar: 'ðŸ”¥', value: 21, unit: 'días' },
      { rank: 3, name: 'Never Skip', avatar: 'ðŸ’ª', value: 21, unit: 'días' },
    ],
  },
];
