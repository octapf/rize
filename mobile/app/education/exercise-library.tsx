          ...
          {filteredExercises.map((exercise) => {
            ...
            return (
              <View key={exercise.id} className="bg-zinc-900 rounded-xl p-5 mb-4 border border-zinc-800">
                ...
                <View className="mb-3">
                  <Text className="text-emerald-400 font-bold mb-2">Primary Muscles</Text>
                  <View className="flex-row flex-wrap gap-2">
                    {exercise.primary.map((muscle, idx) => (
                      <View key={idx} className="bg-emerald-500/20 px-3 py-1 rounded-full border border-emerald-500/30">
                        <Text className="text-emerald-300 text-xs">{muscle}</Text>
                      </View>
                    ))}
                  </View>
                </View>
                ...
                <View className="mb-3">
                  <Text className="text-blue-400 font-bold mb-2">Form Cues</Text>
