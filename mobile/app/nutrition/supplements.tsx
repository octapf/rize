                ...
                return (
                  <View key={timingOption.value} className="mb-6">
                    <View className="flex-row items-center mb-3">
                      <Ionicons name={timingOption.icon as any} size={20} color={`#${timingOption.color === 'amber' ? 'F59E0B' : timingOption.color === 'blue' ? '3B82F6' : timingOption.color === 'primary' ? '9D12DE' : timingOption.color === 'orange' ? 'F97316' : 'A855F7'}`} />
