...
const MOCK_TEMPLATES: WorkoutTemplate[] = [
  {
    ...
    exercises: [
      ...
      { name: 'TrÌceps Polea', sets: 3, reps: '10-12', restSeconds: 60 },
  ...
  },
  {
    ...
    exercises: [
      { name: 'Peso Muerto', sets: 3, reps: '5', restSeconds: 180, notes: 'TÈcnica perfecta' },
      ...
      { name: 'Curl BÌceps', sets: 3, reps: '10-12', restSeconds: 60 },
    ],
  },
  {
    id: '3',
  ...
  },
  {
    ...
    exercises: [
      ...
      { name: 'Curl BÌceps', sets: 2, reps: '12-15', restSeconds: 60 },
      { name: 'TrÌceps Fondos', sets: 2, reps: '12-15', restSeconds: 60 },
    ],
  },
];
                  ...
                  {isExpanded && (
                    <View className="mt-4">
                      ...
                      <View className="flex-row gap-2">
                        ...
                        <TouchableOpacity
                          onPress={() => Alert.alert('Editar', 'FunciÛn de ediciÛn prÛximamente')}
                          className="bg-zinc-800 rounded-lg p-3 items-center justify-center px-4"
                        >
            ...
            <View className="flex-row items-start">
              ...
              <View className="flex-1 ml-3">
                ...
                <Text className="text-purple-300 text-sm">
                  ï Crea variaciones A/B para cada tipo{'\n'}
                  ï Incluye descansos apropiados{'\n'}
                  ï Orden: compuestos primero{'\n'}
                  ï Anota RPE o carga objetivo{'\n'}
                  ï Revisa y ajusta seg˙n progreso
                </Text>
              </View>
            </View>
          </View>
