          ...
          {selectedAge === 'overview' && (
            <View>
              <View className="bg-zinc-900 rounded-xl p-5 mb-6 border border-zinc-800">
                <Text className="text-blue-400 text-xl font-bold mb-3">What Are Masters Divisions?</Text>
              ...
              <View className="bg-zinc-900 rounded-xl p-5 mb-6 border border-zinc-800">
                <Text className="text-emerald-400 text-xl font-bold mb-4">Benefits</Text>
          ...
          {selectedAge === 'recovery' && (
            <View>
              <View className="bg-emerald-500/10 rounded-xl p-5 border border-emerald-500/30 mb-6">
                <Text className="text-emerald-400 font-bold text-lg mb-3">Why Recovery Is Different</Text>
                {currentAge.whyDifferent?.map((reason: string, idx: number) => (
                  <Text key={idx} className="text-emerald-300 text-sm mb-1">• {reason}</Text>
                ))}
              </View>
              ...
              {currentAge.strategies?.map((strategy: any, idx: number) => (
                <View key={idx} className="bg-zinc-900 rounded-xl p-5 mb-6 border border-zinc-800">
                  ...
                  {strategy.effective && (
                    <View className="bg-emerald-500/10 rounded-xl p-4 border border-emerald-500/30 mb-3">
                      <Text className="text-emerald-400 font-bold mb-2">✓ Effective:</Text>
                      {strategy.effective.map((item: string, eIdx: number) => (
                        <Text key={eIdx} className="text-emerald-300 text-sm mb-1">• {item}</Text>
                      ))}
                    </View>
                  )}
                  ...
                  {strategy.protein && (
                    <View className="bg-blue-500/10 rounded-xl p-4 border border-blue-500/30 mb-3">
                      ...
                      {strategy.protein.map((item: string, prIdx: number) => (
                        <Text key={prIdx} className="text-blue-300 text-sm mb-1">• {item}</Text>
                      ))}
                    </View>
                  )}
              ...
              {currentAge.principles?.map((principle: any, idx: number) => (
                <View key={idx} className="bg-zinc-900 rounded-xl p-5 mb-6 border border-zinc-800">
                  ...
                  {principle.recommendations && (
                    <View className="bg-blue-500/10 rounded-xl p-4 border border-blue-500/30 mb-3">
                      <Text className="text-blue-400 font-bold mb-2">Recommendations:</Text>
                  ...
                  {principle.sweetSpot && (
                    <View className="bg-emerald-500/10 rounded-xl p-4 border border-emerald-500/30 mb-3">
                      <Text className="text-emerald-400 font-bold mb-2">Sweet Spot:</Text>
                      {principle.sweetSpot.map((item: string, sIdx: number) => (
                        <Text key={sIdx} className="text-emerald-300 text-sm mb-1">• {item}</Text>
                      ))}
                    </View>
                  )}
                  ...
                  {principle.strategies && (
                    <View className="bg-blue-500/10 rounded-xl p-4 border border-blue-500/30 mb-3">
                      <Text className="text-blue-400 font-bold mb-2">Strategies:</Text>
                      {principle.strategies.map((item: string, stIdx: number) => (
                        <Text key={stIdx} className="text-blue-300 text-sm mb-1">• {item}</Text>
                      ))}
                    </View>
                  )}
                  ...
                  {principle.why && (
                    <Text className="text-blue-400 text-sm mt-3 italic">→ {principle.why}</Text>
                  )}
                </View>
              ))}
            ...
            <View>
              {currentAge.medical?.map((item: any, idx: number) => (
                <View key={idx} className="bg-zinc-900 rounded-xl p-5 mb-6 border border-zinc-800">
                  ...
                  {item.why && (
                    <Text className="text-blue-400 text-sm mt-2 italic">→ {item.why}</Text>
                  )}
              ...
              {currentAge.joints?.map((joint: any, idx: number) => (
                <View key={idx} className="bg-zinc-900 rounded-xl p-5 mb-4 border border-zinc-800">
                  ...
                  <View className="bg-emerald-500/10 rounded-xl p-3 border border-emerald-500/30">
                    <Text className="text-emerald-400 font-bold text-sm mb-1">Management:</Text>
                    {joint.management.map((mgmt: string, mIdx: number) => (
                      <Text key={mIdx} className="text-emerald-300 text-sm mb-1">✓ {mgmt}</Text>
                    ))}
                  </View>
                </View>
              ))}
            ...
            <View>
              {currentAge.perspectives?.map((persp: any, idx: number) => (
                <View key={idx} className="bg-zinc-900 rounded-xl p-5 mb-6 border border-zinc-800">
                  ...
                  {persp.shift && (
                    <View className="bg-emerald-500/10 rounded-xl p-4 border border-emerald-500/30 mb-3">
                      <Text className="text-emerald-400 font-bold mb-2">✓ Success Is:</Text>
