    ...
    alternatives: [
      {
        ...
        equipment: 'Mancuerna ˙nica',
        difficulty: 'easier',
        instructions: 'SostÈn mancuerna vertical frente al pecho. Sentadilla profunda manteniendo torso erguido.',
      ...
      },
      {
        ...
        targetMuscles: ['Cu·driceps', 'Gl˙teos'],
      },
      {
        name: 'Pistol Squats',
        equipment: 'Peso corporal',
        difficulty: 'harder',
        instructions: 'Sentadilla a una pierna. Pierna libre extendida al frente. Balance crÌtico.',
        targetMuscles: ['Cu·driceps', 'Gl˙teos', 'Core', 'Balance'],
      },
      {
        name: 'Sentadilla con Bandas',
        equipment: 'Banda de resistencia',
        difficulty: 'easier',
        instructions: 'Banda bajo pies, agarres en hombros. TensiÛn progresiva en todo el rango.',
        targetMuscles: ['Cu·driceps', 'Gl˙teos'],
      },
    ],
  },
    ...
    alternatives: [
      {
        ...
        targetMuscles: ['Pectorales', 'TrÌceps', 'Hombros'],
      },
      {
        ...
        targetMuscles: ['Pectorales', 'TrÌceps'],
      },
      {
        name: 'Dips en Paralelas',
        equipment: 'Barras paralelas',
        difficulty: 'harder',
        instructions: 'Torso inclinado hacia adelante para Ènfasis pectoral. Descender profundo.',
        targetMuscles: ['Pectorales', 'TrÌceps', 'Hombros'],
      },
      {
        ...
        difficulty: 'easier',
        instructions: 'Banda anclada atr·s, press hacia adelante. TensiÛn progresiva.',
        targetMuscles: ['Pectorales', 'TrÌceps'],
      },
    ],
  },
    ...
    alternatives: [
      {
        ...
        equipment: 'Mancuernas',
        difficulty: 'easier',
        instructions: 'Bisagra de cadera, mancuernas pegadas a piernas. …nfasis isquiotibiales.',
        targetMuscles: ['Isquiotibiales', 'Gl˙teos', 'Espalda baja'],
      },
      {
        name: 'Good Mornings',
        ...
        targetMuscles: ['Isquiotibiales', 'Gl˙teos', 'Erectores'],
      },
      {
        name: 'Single Leg RDL',
        equipment: 'Mancuerna ˙nica',
        difficulty: 'harder',
        instructions: 'Unilateral, pierna libre extendida atr·s. Balance y activaciÛn gl˙teo.',
        targetMuscles: ['Isquiotibiales', 'Gl˙teos', 'Core'],
      },
      {
        ...
        targetMuscles: ['Gl˙teos', 'Isquiotibiales', 'Core'],
      },
    ],
  },
  {
    ...
    alternatives: [
      {
        ...
        difficulty: 'easier',
        instructions: 'Cuerpo inclinado bajo barra. Pull horizontal manteniendo cuerpo rÌgido.',
        targetMuscles: ['Dorsales', 'BÌceps', 'Core'],
      },
      {
        ...
        targetMuscles: ['Dorsales', 'BÌceps'],
      },
      {
        name: 'Dominadas Negativas',
        equipment: 'Barra fija',
        difficulty: 'easier',
        instructions: 'Saltar a posiciÛn superior. Descender controlado 5-10 seg. Solo excÈntrico.',
        targetMuscles: ['Dorsales', 'BÌceps'],
      },
      {
        ...
        difficulty: 'easier',
        instructions: 'Torso paralelo a suelo, pull hacia cadera. RetracciÛn escapular.',
        targetMuscles: ['Dorsales', 'Romboides', 'BÌceps'],
      },
    ],
  },
  {
    ...
    alternatives: [
      {
        ...
        equipment: 'Peso corporal',
        difficulty: 'easier',
        instructions: 'V invertida, caderas arriba. FlexiÛn vertical. ProgresiÛn hacia handstand pushups.',
        targetMuscles: ['Deltoides', 'TrÌceps'],
      },
      {
        name: 'Arnold Press',
        equipment: 'Mancuernas',
        difficulty: 'same',
        instructions: 'RotaciÛn de palmas durante el press. Mayor ROM y activaciÛn deltoides.',
        targetMuscles: ['Deltoides', 'TrÌceps'],
      },
      {
        ...
        equipment: 'Pared',
        difficulty: 'harder',
        instructions: 'Invertido contra pared. Press completo vertical. M·xima dificultad.',
        targetMuscles: ['Deltoides', 'TrÌceps', 'Core'],
      },
      {
        name: 'Press con Bandas',
        equipment: 'Bandas el·sticas',
        difficulty: 'easier',
        instructions: 'Banda bajo pies, press vertical. TensiÛn progresiva m·xima arriba.',
        targetMuscles: ['Deltoides', 'TrÌceps'],
      },
    ],
  },
...
export default function EquipmentAlternatives() {
  ...
  const viewAlternativeDetails = (exercise: string, alternative: any) => {
    Alert.alert(
      alternative.name,
      `Equipo: ${alternative.equipment}\n\n${alternative.instructions}\n\nM˙sculos: ${alternative.targetMuscles.join(', ')}`,
      [{ text: 'Entendido' }]
    );
  };
          ...
          <View className="flex-row items-start">
            ...
            <View className="flex-1 ml-3">
              ...
              <Text className="text-primary/60 text-sm">
                Sin equipo especÌfico? Encuentra alternativas efectivas para cada ejercicio
              </Text>
            </View>
          </View>
        </View>
                ...
                <View className="mt-3 pt-3 border-t border-zinc-800">
                  {item.alternatives.map((alt, index) => (
                    ...
                    >
                      ...
                      {/* Target Muscles */}
                      <View>
                        <Text className="text-zinc-400 text-xs mb-1">M⁄SCULOS</Text>
            ...
            <View className="flex-row items-start">
              ...
              <View className="flex-1 ml-3">
                ...
                <Text className="text-amber-300 text-sm">
                  Rotar entre variaciones previene adaptaciÛn y plateaus. Cambia ejercicios cada 4-6 semanas.
                </Text>
              </View>
            </View>
          </View>
