...
const SUPPLEMENTS: Supplement[] = [
  {
    ...
    timing: 'post-workout',
    frequency: 'daily',
    benefits: ['RecuperaciÛn muscular', 'SÌntesis proteica', 'Saciedad'],
    enabled: true,
    icon: 'üí™',
    color: 'bg-primary',
  },
  {
    ...
    timing: 'post-workout',
    frequency: 'daily',
    benefits: ['Fuerza', 'Potencia', 'Masa muscular', 'RecuperaciÛn'],
    enabled: true,
    icon: '?',
    color: 'bg-amber-500',
  },
  {
    ...
    benefits: ['EnergÌa', 'Focus', 'Rendimiento', 'TermogÈnesis'],
    enabled: true,
    icon: '‚òï',
    color: 'bg-red-500',
  },
  ...
  },
  {
    id: '7',
    name: 'Magnesio',
    category: 'RecuperaciÛn',
    dosage: '400mg',
    timing: 'night',
    frequency: 'daily',
    benefits: ['SueÒo', 'RecuperaciÛn', 'RelajaciÛn muscular'],
    enabled: false,
    icon: 'üåô',
    color: 'bg-indigo-500',
  },
  {
    ...
    timing: 'night',
    frequency: 'daily',
    benefits: ['Testosterona', 'SueÒo profundo', 'RecuperaciÛn'],
    enabled: false,
    icon: 'üí§',
    color: 'bg-purple-500',
  },
...
const STACKS: SupplementStack[] = [
  {
    ...
    supplements: ['ProteÌna Whey', 'Creatina Monohidrato', 'Omega-3', 'Vitamina D3'],
    totalCost: 85,
    monthlyServing: 30,
  },
  {
    ...
    supplements: ['ProteÌna Whey', 'Creatina Monohidrato', 'CafeÌna', 'Beta-Alanina'],
    totalCost: 95,
    monthlyServing: 30,
  },
  {
    id: '3',
    name: 'Stack RecuperaciÛn',
    goal: 'Optimizar descanso y recuperaciÛn',
    supplements: ['ProteÌna Whey', 'Omega-3', 'Magnesio', 'ZMA'],
    totalCost: 90,
    monthlyServing: 30,
  },
];
...
const INTERACTIONS: Interaction[] = [
  {
    ...
    supplement2: 'CafeÌna',
    type: 'negative',
    description: 'La cafeÌna puede reducir la absorciÛn de creatina. Separar por 2-3 horas.',
  },
  {
    supplement1: 'ProteÌna Whey',
    supplement2: 'Creatina Monohidrato',
    type: 'positive',
    description: 'Sinergia positiva. La proteÌna ayuda a transportar creatina al m˙sculo.',
  },
  {
    supplement1: 'Omega-3',
    supplement2: 'Vitamina D3',
    type: 'positive',
    description: 'Mejor absorciÛn cuando se toman juntos con comida grasa.',
  },
  {
    supplement1: 'Magnesio',
    supplement2: 'ZMA',
    type: 'neutral',
    description: 'ZMA ya contiene magnesio. Evitar duplicar dosificaciÛn.',
  },
];
...
export default function SupplementStacks() {
  ...
  const getTimingSchedule = (): TimingSchedule[] => {
    ...
    enabledSupps.forEach((supp) => {
      ...
      switch (supp.timing) {
        case 'morning':
          timeSlot = schedule.find((s) => s.time.includes('MaÒana'));
          break;
        case 'pre-workout':
              ...
              <View className="flex-row items-start">
                ...
                <View className="flex-1 ml-3">
                  ...
                  <Text className="text-primary/60 text-sm">
                    Conoce cÛmo interact˙an tus suplementos para optimizar resultados
                  </Text>
                </View>
              </View>
            </View>
            ...
            <View className="flex-row items-start">
              ...
              <View className="flex-1 ml-3">
                ...
                <Text className="text-amber-300 text-sm">
                  Siempre consulta con un profesional antes de comenzar suplementaciÛn
                </Text>
              </View>
            </View>
          </View>
