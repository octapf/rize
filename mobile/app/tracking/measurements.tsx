...
export default function BodyMeasurements() {
  const [measurements] = useState<Measurement[]>([
    ...
    { bodyPart: 'Hombros', current: 118, previous: 116, change: 2.0, unit: 'cm', icon: '💪', color: 'primary' },
    ...
    { bodyPart: 'Cadera', current: 98, previous: 99, change: -1.0, unit: 'cm', icon: '🍑', color: 'primary' },
    { bodyPart: 'Bíceps Izq', current: 38.5, previous: 37.5, change: 1.0, unit: 'cm', icon: '💪', color: 'blue' },
    { bodyPart: 'Bíceps Der', current: 39.0, previous: 38.0, change: 1.0, unit: 'cm', icon: '💪', color: 'blue' },
  ...
  const getAsymmetry = () => {
    const bicepDiff = Math.abs(measurements.find(m => m.bodyPart === 'Bíceps Izq')!.current - 
                                measurements.find(m => m.bodyPart === 'Bíceps Der')!.current);
