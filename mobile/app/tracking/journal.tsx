...
const MOOD_OPTIONS = [
  ...
  { value: 'great', emoji: '📝', label: 'Genial', color: 'primary' },
];
...
const MOCK_ENTRIES: JournalEntry[] = [
  ...
  },
  {
    ...
    sleep: 8,
    bodyWeight: 78.2,
    notes: 'Peso muerto se sinti• bien, dominadas mejorando.',
  ...
  },
  {
    ...
    energy: 3,
    sleep: 6,
    notes: 'Poco sueño, energía baja. Complet• el workout pero difícil.',
