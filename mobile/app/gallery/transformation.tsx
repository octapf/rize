...
const TRANSFORMATIONS: TransformationPhoto[] = [
  {
    ...
    afterPhoto: 'üí™',
    date: '2025-01-15',
    story: 'De 98kg a 80kg en 90 dÌas. Deficit 500 kcal + 6x semana gym. Sentadilla pasÛ de 80kg a 140kg.',
    stats: {
      workouts: 72,
      diet: 'Flexible IIFYM',
  ...
  },
  {
    ...
    afterPhoto: '??é',
    date: '2025-01-05',
    story: '6 meses que cambiaron mi vida. De sedentario a maratonista. PerdÌ 25kg y ganÈ confianza.',
    stats: {
      workouts: 108,
  ...
  },
  {
    ...
    afterPhoto: 'üíÉ',
    date: '2024-12-28',
    story: 'RecomposiciÛn corporal perfecta. Mismo peso pero -8% grasa corporal. Fuerza m·xima +40%.',
    stats: {
      workouts: 48,
      diet: 'Carb Cycling',
...
export default function TransformationGallery() {
  ...
  const viewTimeline = () => {
    Alert.alert(
      'Timeline Completo',
      `${myProgress.photos.length} fotos en ${myProgress.totalDays} dÌas`,
      [{ text: 'OK' }]
    );
  };
                ...
                <View className="flex-row items-center justify-between mb-4">
                  <View>
                    ...
                    <Text className="text-zinc-400 text-sm">
                      {transformation.duration} dÌas de transformaciÛn
                    </Text>
                  </View>
              ...
              <View className="flex-row gap-3 mb-4">
                <View className="flex-1">
                  ...
                  <Text className="text-zinc-400 text-xs text-center">
                    {myProgress.photos[0].weight}kg ï {myProgress.photos[0].bodyFat}%
                  </Text>
                </View>
                <View className="flex-1">
                  <View className="bg-zinc-800 rounded-lg aspect-square items-center justify-center mb-2">
                  ...
                  <Text className="text-white text-xs text-center font-bold">
                    {myProgress.photos[myProgress.photos.length - 1].weight}kg ï{' '}
