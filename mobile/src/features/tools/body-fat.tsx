...
export default function BodyFatCalculator() {
  ...
  const getBodyFatCategory = (bf: number, isMale: boolean): { category: string; color: string; description: string } => {
    if (isMale) {
      ...
      if (bf < 14) return { category: 'Atlético', color: '#9D12DE', description: 'Óptimo para deportistas' };
      ...
      if (bf < 21) return { category: 'Atlético', color: '#9D12DE', description: 'Óptimo para deportistas' };
